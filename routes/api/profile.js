...
// @route DELETE profile, user, and posts
// @access Private
...
// @route DELTE api/profile/experiece/:exp_id
...
router.get('/github/:username', (req, res) => {
    try {
        const options = {
            uri: `https://api.github.com/users/${req.params.username}/repos?per_page=5&sort=created:acs&client_id${gitHubId}&client_secret=${gitHubSecret}`,
            method: 'GET',
